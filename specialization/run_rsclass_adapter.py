...
# coding=utf-8
"""
Fine-tuning the pretrained language models for Response Selection: Classification on a text file or a dataset.
"""
...
def main():
    ...
    if data_args.dataset_name is not None:
        ...
        datasets = load_dataset('./reddit.py', name=data_args.domain, cache_dir="../DomainReddit/load")
    ...
    if adapter_args.train_adapter:
        task_name = data_args.dataset_name or "rs_class"
